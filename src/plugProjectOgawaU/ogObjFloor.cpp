...
void ObjFloor::setCaveMsgID(u32 caveid, char* buffer)
{
	...
	case 'c_00':              // challenge mode stages
		cave_msg = (char*)(Game::gameSystem->isFruitMode() ? "8390_03" : "4900_00"); // "Valley of Repose" / "Explorer's Cave"
		break;
	case 'c_01':
	...
	case 'c_02':
		...
		break;
	case 'c_03':
		cave_msg = (char*)(Game::gameSystem->isFruitMode() ? "8393_03" : "4903_00"); // "Wistful Wild" / "Creator's Garden"
		break;
	case 'c_04':
		cave_msg = "4904_00"; // "The Giant's Bath"
		break;
	case 'c_05':
		cave_msg = (char*)(Game::gameSystem->isFruitMode() ? "8392_03" : "4905_00"); // "Perplexing Pool" / "Lost Toy Box"
		break;
	case 'c_06':
	...
	case 'c_16':
		...
		break;
	case 'c_17':
		cave_msg = (char*)(Game::gameSystem->isFruitMode() ? "8394_03" : "4917_00"); // "Test Area ID" / "Green Hole"
		break;
	case 'c_18':
	...
	case 'c_19':
		...
		break;
	case 'c_20':
		cave_msg = (char*)(Game::gameSystem->isFruitMode() ? "8391_03" : "4920_00"); // "Awakening Wood" / "Novice Training"
		break;
	case 'c_21':
